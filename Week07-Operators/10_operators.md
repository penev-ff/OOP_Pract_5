...
Имплементирайте клас `NaturalNumber`, който да има абсолютно същото поведение като
`integer`, но да ограничава множеството на целите числа до това на естествените.

Предефинирайте всички нужни оператори.
